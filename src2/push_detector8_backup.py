...
class RobustConnectorTracker:
    ...
    def __init__(self, max_disappeared: int = 30, 
        ...
        # 🆕 Database integration with CSV export
    ...
    def _check_auto_reset(self, terminals: List[Dict[str, Any]]) -> bool:
        ...
        if all_complete and not self.auto_reset_triggered:
            ...
            if elapsed >= self.auto_reset_delay:
                ...
                self.auto_reset_triggered = True
                return True
...
def test_robust_tracking_system(model_path: str, video_source: Optional[str] = None,
    ...
    """
    Test the robust proximity-based tracking system with database and CSV export
    """
...
if __name__ == "__main__":
    print("🎯 Robust Connector Tracking - Database with CSV Export")
    print("="*60)
    ...
    print("\n🚀 Starting robust tracking system with database and CSV export...")
